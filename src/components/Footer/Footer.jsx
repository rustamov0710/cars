  ...
  return (
    <footer className="">
      <div className="container px-4 border-t pt-6 ">
          ...
          <div className="max-w-[545px] w-[100%] sm:w-1/5">
            ...
            <ul className="list-three">
                <li className="flex items-start flex-col gap-2">
                  <a href="#" className="w-[100px] hover:text-blue-600 text">Audi</a>
                  <a href="#" className="w-[100px] hover:text-blue-600 text">Aston Martin</a>
                  <a href="#" className="w-[100px] hover:text-blue-600 text">Acura</a>
                  <a href="#" className="w-[100px] hover:text-blue-600 text">Alfa Romeo</a>
                  <a href="#" className="w-[100px] hover:text-blue-600 text">Avatr</a>
                  </li>
                <li className="flex items-start flex-col gap-2">
        ...
        {/* Footer Bottom */}
        <div className="list-four mt-6 mb-3 flex justify-between items-center text-sm text-gray-500 pt-4">
          <p className="bottom-text">Политика конфиденциальности</p>
          <p className="bottom-text">Сделано в UserTech</p>
        </div>
      </div>
    </footer>
  );
